...
export const NAV_ITEMS: NavItem[] = [
  { id: 'home', label: { uz: 'Bosh Sahifa', ru: 'Главная', en: 'Home' } },
  { id: 'sectors', label: { uz: 'Sohalar', ru: 'Отрасли', en: 'Sectors' } },
  { id: 'technologies', label: { uz: 'Texnologiyalar', ru: 'Технологии', en: 'Technologies' } },
  { id: 'statistics', label: { uz: 'Statistika', ru: 'Статистика', en: 'Statistics' } },
